    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card card-outline card-info">
                ...
                <div class="card-header">
                    <h3 class="card-title">
                        <?php echo e(__('adminPanel.Edit Page')); ?>
        ...
        <form action="<?php echo e(route('pages.update',['page'=>$page->id])); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
           ...
           <?php echo method_field('put'); ?>
            ...
            <div class="form-group">
                <label  for="title"><?php echo e(__('adminPanel.Slug')); ?></label>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control">
                            <option value="0" <?php echo e($page->status=='0' ? 'selected' : ''); ?>><?php echo e(__('adminPanel.Draft')); ?></option>
                            <option value="1" <?php echo e($page->status=='1' ? 'selected' : ''); ?>><?php echo e(__('adminPanel.publish')); ?></option>
...
<?php echo $__env->make('Admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUSGAMİNG\Desktop\ustashow backup\ustashow.com\resources\views/Admin/pages/edit.blade.php ENDPATH**/ ?>