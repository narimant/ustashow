...
<?php $__currentLoopData = $child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($item->sub_category->count()): ?>
        <?php $i++; ?>
        <?php echo $__env->make('Admin.category.catedit',['child' => $item->sub_category ,'i' => $i], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\ustashow\ustashow\resources\views/Admin/category/catedit.blade.php ENDPATH**/ ?>