                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if(request()->get('show')=="trash"): ?>
                                        <?php echo e(route('article.forceDelete' , ['id'=>$video->id])); ?>

                                    <?php else: ?>
                                        <?php echo e(route('articles.destroy' , ['article'=>$video->id])); ?>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <div class="btn btn-group">
                                            <a   href="<?php echo e(route('articles.edit', [ 'article'=>$video->id])); ?>" class="btn btn-primary"><?php echo e(__('adminPanel.Edit')); ?></a>
                                           <?php if(request()->get('show')=='trash'): ?>
                                                <a   href="<?php echo e(route('article.restore', [ 'id'=>$video->id])); ?>" class="btn btn-success"><?php echo e(__('adminPanel.Restore')); ?></a>
                                            <?php endif; ?>
                                            <?php if(request()->get('show')=='draft'): ?>
                                                <a   href="<?php echo e(route('article.publish', [ 'id'=>$video->id])); ?>" class="btn btn-success"><?php echo e(__('adminPanel.Publish')); ?></a>
                                            <?php endif; ?>
