...
<ul class="navbar-nav">
    ...
    <?php $__currentLoopData = \App\Category::where('parent_id',null)->where('lang',app()->getLocale())->with('sub_category')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <a class="nav-link  <?php echo e($value->sub_category->count() ? "dropdown-toggle" :""); ?>" href=" <?php echo e($value->path()); ?>" id="navbarPages" <?php echo e($value->sub_category->count() ? "data-bs-toggle='dropdown''" :""); ?> aria-haspopup="true" aria-expanded="false">
...
<?php /**PATH /home/ustashow/domains/ustashow.com/resources/views/frontend/frontendlayout/catmenu.blade.php ENDPATH**/ ?>