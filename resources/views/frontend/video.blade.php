                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex align-items-center">
                                    <img src="{{$video->user->userimage()}}" class="rounded-circle avatar-md"
                                         alt="">
                                    <div class="ms-2 lh-1">
                                        <h4 class="mb-1"></h4>
                        ...
                        <div class="card-body">
                            ...
                            <span class="position-absolute ps-3">
                              <i class="fe fe-search"></i>
                                ...
                                @include('frontend.frontendlayout.comments',['comments'=>$comment,'subject'=>$video])
                            </div>
