                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(request()->get('show')=="trash")
                                        {{ route('article.forceDelete' , ['id'=>$video->id]) }}
                                    @else
                                        {{ route('articles.destroy' , ['article'=>$video->id]) }}
                                    @endif
                                        ...
                                        <div class="btn btn-group">
                                            <a   href="{{ route('articles.edit', [ 'article'=>$video->id]) }}" class="btn btn-primary">{{__('adminPanel.Edit')}}</a>
                                           @if(request()->get('show')=='trash')
                                                <a   href="{{ route('article.restore', [ 'id'=>$video->id]) }}" class="btn btn-success">{{__('adminPanel.Restore')}}</a>
                                            @endif
                                            @if(request()->get('show')=='draft')
                                                <a   href="{{ route('article.publish', [ 'id'=>$video->id]) }}" class="btn btn-success">{{__('adminPanel.Publish')}}</a>
                                            @endif
